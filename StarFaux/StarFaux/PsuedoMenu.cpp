...
void PsuedoMenu::generateMenu(float height, float width) {
	...
	m_vertices[0] = vec4(-width/2.0, -height/2.0, -0.0001, 1.0);
	m_vertices[1] = vec4( width/2.0,  height/2.0, -0.0001, 1.0);
	m_vertices[2] = vec4(-width/2.0,  height/2.0, -0.0001, 1.0);

	m_vertices[3] = vec4(-width/2.0, -height/2.0, -0.0001, 1.0);
	m_vertices[4] = vec4( width/2.0, -height/2.0, -0.0001, 1.0);
	m_vertices[5] = vec4( width/2.0,  height/2.0, -0.0001, 1.0);
